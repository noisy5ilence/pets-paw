This is a [PetsPaw](https://nextjs.org/) project implemented with [`NextJS`](https://nextjs.org/), [`ReactQuery`](https://tanstack.com/query/v3/), [`Axios`](https://axios-http.com/) and [`The Cat API`](https://thecatapi.com/)
