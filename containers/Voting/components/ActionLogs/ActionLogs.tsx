...
import classes from './ActionLogs.module.css';

interface Props {
  logs: Array<Log>;
}

export const ActionLogs: FC<Props> = ({ logs }) => {
  return (
        ...
        return (
          <li key={id} className={classes.item}>
            ...
            <span className={classes.info}>
              Image ID: <b>{image_id}</b> was added to { value > 0 ? 'Likes' : value < 0 ? 'Favourites' : 'Dislikes' }
            </span>
