...
import classes from './BreedsSearch.module.css';

export const BreedsSearch: FC = () => {
  ...
  return (
    <form className={classes.search} onSubmit={handleSubmit}>
      <input className={classes.input} type='text' value={query} onChange={handleChange} placeholder='Search for breeds by name'/>
      <button className={cn('button', classes.submit)} type='submit'>
