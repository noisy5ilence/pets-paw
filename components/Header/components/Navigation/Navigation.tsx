...
const items: [keyof typeof routes, ReactElement][] = [
  ['likes',
    <svg key='likes' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  ['favourites',
    <svg key='favourites' width="30" height="26" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  ['dislikes',
    <svg key='dislikes' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { items.map(([key, icon]) => {
          ...
          return (
            <li className={classes.item} key={key}>
              <button className={cn('button vector', {'active': isActive})}>
