...
export const Breadcrumbs: FC = () => {
  ...
  const pageKey = router.route.replace('/', '') as keyof typeof routes;
  ...
  return (
    <ul className={classes.breadcrumbs}>
      <li className={classes.item}>
        <button className={cn('button', classes.back)} onClick={() => router.back()}>
      ...
      <li className={cn(classes.breadcrumb, classes.item, {[classes.active]: route.path === router.route})}>
